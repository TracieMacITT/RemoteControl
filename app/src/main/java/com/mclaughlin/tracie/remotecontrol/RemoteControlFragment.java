package com.mclaughlin.tracie.remotecontrol;
...
/**
 * Created by Tracie on 7/26/2016.
 */
public class RemoteControlFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent,
        ...
        View v = inflater.inflate(R.layout.fragment_remote_control_main, parent, false);
...
//        oneButton.setOnClickListener(numberButtonListener);
        TableLayout tableLayout = (TableLayout) v
                .findViewById(R.id.fragment_remote_conrtol_tableLayout);
        int number = 1;
